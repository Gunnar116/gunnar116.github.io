...
export const truopsPlatformCaseStudy: CaseStudyContent = {
  ...
  notice:
    'This case study reflects real product work for a high-security enterprise SaaS platform. Some details, screens, and implementation specifics have been abstracted or omitted.',
  ...
  decisions: [
    ...
    },
    {
      ...
      body: 'Tables, filters, side panels, summary cards, and empty states: the platform now leans on a small set of shared patterns rather than re-inventing them per feature. Consistency reduces cognitive load and speeds up shipping.',
    },
    {
  ...
  outcome:
    'The redesign produced a clearer information architecture, task-driven interfaces that move users through complex workflows faster, a component-based design system that brought consistency across the platform, better onboarding and guidance patterns for new users, and a stronger foundation for Clark and future AI-assisted product features to land cleanly inside the existing experience. Pilot users and internal teams reported a clearer, cleaner platform that aligned with how they actually work. Outcomes reported in the original case study: an 85% reduction in user onboarding time, a 25% click reduction across key workflows, and a 34% increase in feature discoverability. As the redesign continues to roll out, the foundation supports the next chapter of TruOps as a more intuitive, scalable, and AI-ready GRC platform.',
