...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    homeImage: {
      ...
      alt: 'Kindness.ai inbox shown in a browser frame on a soft Kindigo-tinted backdrop, with sidebar label filters, row-level label chips, and the message list, composed as an editorial product hero.',
      fit: 'cover',
    },
  },
  {
